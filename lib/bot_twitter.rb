...
def journalist_select(list_handles)
   journalist = list_handles.sample(5)
     journalist.each do |handles|
        login_twitter.update "#{handles} Hello de Samir et Aurélien, moussaillons @the_hacking_pro #bonjour_monde"
     end
end
